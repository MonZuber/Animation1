...
function HR(game, spritesheet) {
    this.animation = new Animation(spritesheet, 120, 90, 14, 0.13, 14, true, 2);
...
HR.prototype = new Entity();
HR.prototype.constructor = HR;

HR.prototype.draw = function () {
...
function running(game, spritesheet) {
    this.animation = new Animation(spritesheet, 90, 45, 8, 0.13, 8, true, 3);
...
running.prototype.update = function () {
   if (this.animation.elapsedTime < this.animation.totalTime)
        this.x += this.game.clockTick * this.speed -1.5;
    if (this.x > 800) this.x = -230;
    Entity.prototype.update.call(this);
}

running.prototype.draw = function () {
    this.animation.drawFrame(this.game.clockTick, this.ctx, this.x, this.y+200);
    Entity.prototype.draw.call(this);
...
Guy.prototype.draw = function () {
    this.animation.drawFrame(this.game.clockTick, this.ctx, this.x, this.y+150);//changed here to move up and down
    Entity.prototype.draw.call(this);
}
*/
...
AM.downloadAll(function () {
    ...
    gameEngine.addEntity(new HR(gameEngine, AM.getAsset("./img/HRS.png")));
